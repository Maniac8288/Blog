namespace DataModel.Migrations
{
    ...
    public partial class begin : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        upload = c.String(),
                        Author = c.String(),
                        SelectCategories_Id = c.Int(),
                    })
                .PrimaryKey(t => t.PostID)
                .ForeignKey("dbo.Categories", t => t.SelectCategories_Id)
                .Index(t => t.SelectCategories_Id);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Posts", "SelectCategories_Id", "dbo.Categories");
            ...
            DropIndex("dbo.Posts", new[] { "SelectCategories_Id" });
